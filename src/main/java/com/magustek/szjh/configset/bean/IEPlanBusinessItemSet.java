...
public class IEPlanBusinessItemSet extends BaseEntity{
    public static final transient String CALC = "C";    //计算出来的值（计划值）
    public static final transient String GET = "G";     //取出来的值（实际值）
    public static final transient String WORK_DAY = "W";//合同约定-工作日
    ...
    @Column(length = 4) private String caart;//到上一环节历史能力值
    ...
    @Column(length = 4) private String exbtr;//排除金额
